...
namespace RPG_Guild_Lib.Lib
{
    public class ModHtmlTools
    {
        ...
        * ImageLimit_MaxKilobyte", "ImageLimit_MaxZipedWidth", "ImageLimit_MaxZipedHeight" */
        ...
        private string[] thisInfo = new string[2];  //20170819-好像可以用這樣回傳?
        ...
        public string[] getInfo() { return thisInfo; }
        ...
        private void modHtml(string FileName)
        {
            ...
            //臨時性的方法，如更好的方法研究成功，建議改善。這邊要用Task回傳訊息
            ...
            thisInfo[0] = FileName + @"...完成!" + "\n"; //先用這樣撐著
            thisInfo[1] = "ForestGreen";
        }
